...
exports.BinhLuanModule = void 0;
const common_1 = require("@nestjs/common");
const binh_luan_service_1 = require("./binh-luan.service");
const binh_luan_controller_1 = require("./binh-luan.controller");
let BinhLuanModule = class BinhLuanModule {
};
BinhLuanModule = __decorate([
    (0, common_1.Module)({
        providers: [binh_luan_service_1.BinhLuanService],
        controllers: [binh_luan_controller_1.BinhLuanController]
    })
], BinhLuanModule);
exports.BinhLuanModule = BinhLuanModule;
